...
export const Sidebar: React.FC<SidebarProps> = ({  }) => {
  ...
  return (
    <div className="flex flex-col w-64 h-full">
      ...
      <div className="flex flex-col h-0 flex-1 border-r border-gray-200 bg-white dark:bg-gray-darkest dark:text-white">
        <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
          <div className="flex items-center flex-shrink-0 px-4">
            <img className="h-8 w-auto text-red-200" src="https://tailwindui.com/img/logos/workflow-logo-indigo-600-mark-gray-800-text.svg" alt="Workflow"/>
          </div>
